...
import VIEW.CustomerKasirMenu;
import java.awt.event.ActionEvent;
import java.awt.event.ActionListener;
import javax.swing.JOptionPane;

public class CustomerKasirController {
    private final CustomerModel model;
    private final CustomerKasirMenu view;
    
    public CustomerKasirController(CustomerModel m, CustomerKasirMenu v) {
        model = m;
        view = v;
        initView();
    }
